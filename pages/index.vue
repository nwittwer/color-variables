...
<style lang="scss">
@use '~/assets/scss/tokens'; // Import tokens & themes
...
button {
  ...
  &.button--secondary {
    ...
    &:active {
      background: var(--brand-secondary-color-dark);
    }
  }
}
